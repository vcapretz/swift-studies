...
//  DesingCode1
//
//  Created by Vitor Capretz on 2020-05-12.
...
struct BottomCardView: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            ScrollView {
                Text("This certificate is proof that Vitor Capretz has achieved the UI Design course with approval from a Design+Code instructor.")
